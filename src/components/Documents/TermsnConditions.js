...
const TermsnConditions = () => {
  ...
  <div data-custom-class="body">
          ...
          >
            ...
            >
              ...
              >
                ...
                at{" "}
                <bdt className="question">
                  3-12, Jagadeesh Market, 4, Mahankali St, General Bazaar,
                  Kalasiguda,
                </bdt>
                <bdt className="block-component" />
              </span>
            ...
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                <span style={{ color: "rgb(89, 89, 89)" }}>
                  ...
                  <bdt className="statement-end-if-in-editor" />
                  <bdt className="block-component" />{" "}
                  <bdt className="question">500003</bdt>
                  <bdt className="statement-end-if-in-editor" />
                </span>
              </span>
            </span>
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <span style={{ color: "rgb(0, 58, 250)" }}>
            <bdt className="question">
              <a
                href="https://batchugold.com/"
                target="_blank"
                data-custom-class="link"
              >
                https://batchugold.com/
              </a>
            </bdt>
          </span>{" "}
      ...
      >
        <bdt className="question">
          We provide Digital Gold and Physical Gold Goods
        </bdt>
      </div>
      <div
        className="MsoNormal"
      ...
      >
        ...
        >
          ...
          phone at <bdt className="question">9391935555</bdt>, email at{" "}
          <bdt className="question">mail@batchugold.com</bdt>
          <bdt className="block-component" />,
          <bdt className="statement-end-if-in-editor" /> or by mail to{" "}
          <bdt className="question">
            3-12, Jagadeesh Market, 4, Mahankali St, General Bazaar, Kalasiguda,
          </bdt>
          <bdt className="block-component" />,{" "}
          <bdt className="question">Secunderabad</bdt>
          <bdt className="block-component" />,{" "}
      ...
      >
        ...
        >
          ...
          <bdt className="statement-end-if-in-editor" />
          ), and <bdt className="question">Batchu Gold</bdt>, concerning your
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        <a data-custom-class="link" href="#mobile">
          <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
            <span data-custom-class="body_text">
              <bdt className="block-component" />
              13. MOBILE APPLICATION <bdt className="block-component" />
              LICENSE
              <bdt className="statement-end-if-in-editor" />
              <bdt className="statement-end-if-in-editor" />
            </span>
      ...
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        <a data-custom-class="link" href="#sitemanage">
          <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
            <span data-custom-class="body_text">16. SERVICES MANAGEMENT</span>
          </span>
        </a>{" "}
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <bdt className="question">mail@batchugold.com</bdt>. If we ever grant
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        <strong>
          <span style={{ fontSize: 19 }}>7. SUBSCRIPTIONS</span>
        </strong>
      </div>
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        <bdt className="block-component" />
      ...
      >
        <span style={{ fontSize: 15 }}>
          ...
          <bdt className="block-component">is&nbsp;</bdt>
          <bdt className="question">daily</bdt>
          <bdt className="statement-end-if-in-editor" />.
          <bdt className="statement-end-if-in-editor" />
          <bdt className="else-block" />
        </span>
      ...
      >
        ...
        <strong>
          ...
          <span style={{ color: "rgb(0, 58, 250)" }}>
            ...
            >
              <a
                href="https://batchugold.com/privacypolicy"
                target="_blank"
                data-custom-class="link"
              >
                https://batchugold.com/privacypolicy
              </a>
            </bdt>
          </span>
        </strong>
    ...
    >
      ...
      >
        ...
        . <bdt className="question">Batchu Gold</bdt> and yourself irrevocably
    ...
    >
      <span style={{ fontSize: 15 }}>
        ...
        <bdt className="question">Batchu Gold</bdt> shall also maintain the
    ...
    >
      <strong>
        ...
        >
          <strong>
            <bdt className="block-component" />
            Phone: <bdt className="question">9391935555</bdt>
            <bdt className="statement-end-if-in-editor" />
          </strong>
        </span>
        &nbsp;
