...
const GoldInvestmentCalculator = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-yellow-400 to-orange-500 text-white p-4 sm:p-6 md:p-8 rounded-2xl">
      ...
      <div className="flex flex-col sm:flex-row sm:space-x-10 mb-6 sm:mb-8">
        <div className="flex flex-col items-center mb-4 sm:mb-0">
          ...
          <input
            ...
            className="slider w-full sm:w-64 h-8 sm:h-10 bg-gray-200 rounded-lg appearance-none cursor-pointer"
          />
      ...
      <div className="text-center text-sm sm:text-lg space-y-4 bg-white text-black p-4 sm:p-6 rounded-lg shadow-lg">
